...
var EmployeeTitle_Pipe_1 = require("./customPipe/EmployeeTitle.Pipe");
var EmployeeCount_component_1 = require("./employeeCount/EmployeeCount.component");
var SimpleComponent_1 = require("./other/SimpleComponent");
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [app_component_1.AppComponent, Employee_Component_1.EmployeeComponent, EmployeeList_component_1.EmployeeListComponent,
                EmployeeTitle_Pipe_1.EmployeeTitlePipe, EmployeeCount_component_1.EmployeeCountComponent, SimpleComponent_1.SimpleComponent, home_component_1.HomeComponent, pageNotFound_component_1.PageNotFoundComponent],
